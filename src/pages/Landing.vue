    ...
    <div>
        ...
        <div class="section section-about-us">
            <div class>
                <div class="row mx-0">
                    <div
                        class="col-md-8 ml-auto mr-auto text-center first-text-container"
                    >
                        <transition name="item">
                            <h2 class="title" v-if="showFirstText">
                                {{ $t("aboutUsTitle") }}
                            </h2>
                        </transition>
                        <transition name="item">
                ...
                <div class="section-story-overview">
                    <div class="row mx-0">
                        ...
                        <div
                            class="col-md-12 text-center px-0 py-5 values-container"
                        >
                            <div class="mb-5">
                                ...
                                <div
                                    v-for="value in values[this.$i18n.locale]"
                                    :key="value.title"
                                >
                                    <transition name="item">
                                        <h4
        ...
        <div class="section section-team text-center mb-4">
            <div class="container">
                ...
                <p class="description mb-5">{{ $t("partnersText") }}</p>
                <div class="team mt-2" v-if="showTeam">
                    <template>
                        <sequential-entrance>
                            <div class="row mx-0">
                                <div
                                    class="col-md-6 mb-4"
                                    v-for="t in team[this.$i18n.locale]"
                                    :key="t.key"
                                >
            ...
            pages: [
                ...
                },
                {
                    ...
                    clients: [
                        ...
                        {
                            key: 20,
                            url: "https://www.playasonorarealty.com/",
                            name: "Playa Sonora Realty",
                        },
                        {
                            key: 21,
                            url: "",
                        ...
                        {
                            key: 22,
                            url: "https://www.vecinoapp.com/",
                            name: "Vecino App",
                        },
                        {
                            key: 23,
                            url: "https://penascorentals.com/",
                            name: "Peñasco Sales & Rentals",
                        },
                    ],
                },
            ],
